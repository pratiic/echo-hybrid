      ...
      >
        {list.map((content) => {
          if (type === "product" || type === "seller") {
            return <ContentCard {...content} key={content.id} type={type} />;
          }
          if (type === "notification") {
            return <NotificationCard {...content} key={content.id} />;
          }
          if (type === "order") {
          ...
          if (type === "transaction") {
            return <TransactionCard {...content} key={content.id} />;
          }
          ...
          if (type === "business-request") {
            return <BusinessRequest {...content} key={content.id} />;
          }

          if (type === "category-request") {
            return <CategoryRequest {...content} key={content.id} />;
          }
