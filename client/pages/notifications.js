...
const Notifications = () => {
    ...
    if (notifications.length > 0) {
      dispatch(
        showConfirmationModal({
          ...
          handler: async () => {
            dispatch(showLoadingModal("deleting all notifications..."));
  ...
  return (
    <section>
      ...
      <PageHeader heading="your notifications" hasBackArrorw>
        <p
      ...
      <div
        className={`-mt-2 ${
          notifications?.length > 0 ? "w-fit mx-auto 700:mx-0" : "w-full"
        }`}
      >
        <ContentList
          list={notifications}
          ...
          error={error}
          emptyMsg="you dont have any notifications"
