...
import { showConfirmationModal } from "../redux/slices/modal-slices";
  ...
  return (
    <section>
      ...
      <InfoBanner liftUp={false} className="space-y-3">
        ...
        <p>
          1. You may be an individual seller with no business and sell second
          hand products with no stock or variation.
        </p>
        <p>
          2. You may be a seller with a reigstered business and sell new
          products with stocks and variations.
        </p>
        <p className="font-semibold">
