...
const Sell = () => {
    ...
    const handleContinueClick = () => {
        ...
        return dispatch(
            showConfirmationModal({
                title: `sell as ${type}`,
                message: `You cannot change your seller orientation unless you delete your seller profile later. Are you sure you want to continue ?`,
                handler: async () => {
                    setLoading(true);
    ...
    return (
        <section>
            ...
            <InfoBanner className="space-y-2">
